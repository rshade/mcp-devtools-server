...
export class KnowledgeBase {
  ...
  private initializePatterns(): void {
    ...
    this.addPattern({
      ...
      patterns: [/FAIL[:\s]+(.+)/, /--- FAIL: (.+?) \(/, /test timed out/],
      severity: "high",
      suggestions: [
    ...
    this.addPattern({
      ...
      patterns: [/WARNING: DATA RACE/, /Found \d+ data race/],
      severity: "high",
      suggestions: [
    ...
    this.addPattern({
      ...
      patterns: [/golangci-lint.+?error|warning/i, /\d+ issues? found/],
      severity: "medium",
      suggestions: [
    ...
    this.addPattern({
      ...
      name: "ESLint Errors",
      category: Category.Lint,
      patterns: [/\d+:\d+\s+error/, /✖ \d+ problems?/],
      severity: "medium",
      suggestions: [
    ...
    this.addPattern({
      ...
      category: Category.Security,
      patterns: [/sql.*?query.*?\+/i, /execute\(.*?\+.*?\)/i, /SELECT.*?\$\{/i],
      severity: "high",
      suggestions: [
    ...
    this.addPattern({
      ...
      category: Category.Security,
      patterns: [/segmentation fault/i, /SIGSEGV/, /core dumped/i],
      severity: "high",
      suggestions: [
