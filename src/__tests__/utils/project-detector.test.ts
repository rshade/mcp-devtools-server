...
describe('ProjectDetector', () => {
  ...
  describe('Package Manager Detection', () => {
    it('detects npm when package-lock.json exists', async () => {
      const detector = new ProjectDetector(path.join(fixturesDir, 'npm-project'));
    ...
    it('detects yarn when yarn.lock exists', async () => {
      const detector = new ProjectDetector(path.join(fixturesDir, 'yarn-project'));
      const info = await detector.detectProject();
    ...
    it('detects pnpm when pnpm-lock.yaml exists', async () => {
      const detector = new ProjectDetector(path.join(fixturesDir, 'pnpm-project'));
      const info = await detector.detectProject();
    ...
    it('returns undefined when no Node.js package files exist', async () => {
      const detector = new ProjectDetector(path.join(fixturesDir, 'python-project'));
      const info = await detector.detectProject();
  ...
  describe('Project Type Detection', () => {
    ...
    it('detects Go project from go.mod', async () => {
      const detector = new ProjectDetector(path.join(fixturesDir, 'go-project'));
      const info = await detector.detectProject();
    ...
    it('detects Rust project from Cargo.toml', async () => {
      const detector = new ProjectDetector(path.join(fixturesDir, 'rust-project'));
      const info = await detector.detectProject();
    ...
    it('returns Unknown type for unrecognized projects', async () => {
      const detector = new ProjectDetector(path.join(fixturesDir, '..', 'text'));
      const info = await detector.detectProject();
  ...
  describe('Configuration Files Detection', () => {
    it('finds package.json in Node.js projects', async () => {
      ...
      const packageJson = info.configFiles.find(f => f.name === 'package.json');
    ...
    it('returns empty array when no config files found', async () => {
      const detector = new ProjectDetector(path.join(fixturesDir, '..', 'binary'));
      const info = await detector.detectProject();
  ...
  describe('Caching Behavior', () => {
    ...
    it('uses different cache entries for different project paths', async () => {
      const npmDetector = new ProjectDetector(path.join(fixturesDir, 'npm-project'));
      const pythonDetector = new ProjectDetector(path.join(fixturesDir, 'python-project'));
