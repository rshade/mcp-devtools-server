...
describe('SmartSuggestionsTools - Validation', () => {
  describe('validateAnalyzeCommandArgs', () => {
    ...
    it('should reject empty command', () => {
      ...
      expect(() => SmartSuggestionsTools.validateAnalyzeCommandArgs(args)).toThrow();
    });
  ...
  describe('validateGetKnowledgeBaseStatsArgs', () => {
    it('should accept empty arguments', () => {
      ...
      const validated = SmartSuggestionsTools.validateGetKnowledgeBaseStatsArgs(args);
  ...
  describe('validateRecommendMCPServersArgs', () => {
    it('should accept empty arguments', () => {
      ...
      const validated = SmartSuggestionsTools.validateRecommendMCPServersArgs(args);
      expect(validated).toEqual({});
    });
    ...
    it('should reject invalid priority', () => {
      ...
      expect(() => SmartSuggestionsTools.validateRecommendMCPServersArgs(args)).toThrow();
    });
  ...
  describe('validateGetPerformanceMetricsArgs', () => {
    it('should accept empty arguments', () => {
      ...
      const validated = SmartSuggestionsTools.validateGetPerformanceMetricsArgs(args);
      expect(validated).toEqual({});
    });
    ...
    it('should accept different namespaces', () => {
      const namespaces = ['smartSuggestions', 'projectDetection', 'fileScanning'];
