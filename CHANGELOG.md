...
## [0.2.2](https://github.com/rshade/mcp-devtools-server/compare/mcp-devtools-server-v0.2.1...mcp-devtools-server-v0.2.2) (2026-03-25)


### Added

* **python:** add comprehensive Python language support with 14 tools ([0b1f6d8](https://github.com/rshade/mcp-devtools-server/commit/0b1f6d864d208542bc49231b3b27c179a15f6fb6))

## [0.2.1](https://github.com/rshade/mcp-devtools-server/compare/mcp-devtools-server-v0.2.0...mcp-devtools-server-v0.2.1) (2025-11-25)
